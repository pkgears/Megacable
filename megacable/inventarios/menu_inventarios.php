...
<body>
	<div class="" id="contenido">
		...
		<section id="central">
			<div class="menu">
				<ul>
					<li><a href="inventario_acutal.php">Inventario actual</a></li>
					<li><a href="inventarios_anteriores.php">Inventarios anteriores</a></li>
					<li><a href="nuevo_inventario.php">Nuevo inventario</a></li>
				</ul>
			</div>
		</section>
		<footer>
