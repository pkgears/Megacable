	...
	<div class="" id="contenido">
		...
		<section id="central">
			<?php 
				...
				echo "<h2>¿Seguro que desea crear la nueva bitacora para ".$row['nombre']." ".$row['apellido']."?";
				echo "<div class='otro' >
						<a href='bitacoras/crear_bit_link.php?id=".$row['id_tecnico']."'><img src='img/ok.png' alt='Editar' width=50px height=50px title='Aceptar'></a>
						<a href='inicio.php'><img src='img/cancelar.png' alt='Editar' width=50px height=50px title='Cancelar'></a>
					</div>"
			 ?>
		</section>
		<footer>
